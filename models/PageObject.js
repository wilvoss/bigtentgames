...
var Pages = [
  ...
  new PageObject({
    name: 'Kindred Cats!',
    description: 'A game of matching cat likenesses',
    path: 'kindredcats',
    ...
    about: '<p>Reminiscent of the card game "Set," the object of this fast-paced, casual mobile game is to observe the main cat and then select all other cats on the board that share <b>at least 2</b> of the following 3 attributes: color, shape, and pattern. There are 4 unique games modes for all types of players!</p>',
    aboutExtra: [
      '<h2>Ranks</h2>',
  ...
  //   iconUrl: 'images/likeme/icon512-btg.svg',
  //   features: ['Brain training', 'Casual gameplay', 'Competitive gameplay', 'Alternate patterns', 'Color themes', 'Dark mode', 'Cat mode!', 'Score sharing', 'High scores'],
