...
var Pages = [
  ...
  new PageObject({
    ...
    iconUrl: 'images/facets/icon512-btg.png',
  ...
  new PageObject({
    ...
    iconUrl: 'images/likeme/icon512-btg.png',
  ...
  new PageObject({
    ...
    iconUrl: 'images/dropnstop/icon512-btg.png',
  ...
  new PageObject({
    ...
    iconUrl: 'images/commoddities/icon512-btg.png',
  ...
  new PageObject({
    ...
    iconUrl: 'images/path/icon512-btg.png',
